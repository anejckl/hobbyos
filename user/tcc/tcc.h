...
# endif
#endif
/* HobbyOS: -run/JIT mode (tccrun.c, not vendored) is permanently out of
 * scope — it needs mmap+PROT_EXEC+jump-to-generated-code, which this
 * kernel can't safely support mid-preemption. Force the same code path
 * TCC already uses for ordinary cross-compilation (e.g. compiling ARM
 * code from an x86 host), where TCC_IS_NATIVE is naturally undefined. */
#undef TCC_IS_NATIVE
